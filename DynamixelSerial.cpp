...
// data members 
//bool DynamixelClass::is_cw=true;
...
int DynamixelClass::setID( unsigned char newID)
{    
...
int DynamixelClass::setBD( long baud)
{    
...
int DynamixelClass::move( int Position)
{
...
int DynamixelClass::moveSpeed( int Position, int Speed)
{
...
int DynamixelClass::setEndless( bool Status)
{
 if ( Status ) {	
...
int DynamixelClass::turn( bool SIDE, int Speed)
{		
		if (SIDE == 0){                          // Move Left///////////////////////////
...
int DynamixelClass::moveRW( int Position)
{
    char Position_H,Position_L;
    Position_H = Position >> 8;           // 16 bits - 2 x 8 bits variables
    Position_L = Position;
...
int DynamixelClass::moveSpeedRW( int Position, int Speed)
{
    char Position_H,Position_L,Speed_H,Speed_L;
    Position_H = Position >> 8;    
    Position_L = Position;                // 16 bits - 2 x 8 bits variables
...
int DynamixelClass::torqueStatus(  bool Status)
{
...
int DynamixelClass::ledStatus( bool Status)
{    
...
int DynamixelClass::readTemperature()
{	
...
int DynamixelClass::readPosition()
{	
...
int DynamixelClass::readVoltage()
{    
...
int DynamixelClass::setTempLimit( unsigned char Temperature)
{
...
int DynamixelClass::setVoltageLimit( unsigned char DVoltage, unsigned char UVoltage)
{
...
int DynamixelClass::setAngleLimit( int CWLimit, int CCWLimit)
{
...
int DynamixelClass::setMaxTorque( int MaxTorque)
{
...
int DynamixelClass::setSRL( unsigned char SRL)
{    
...
int DynamixelClass::setRDT( unsigned char RDT)
{    
...
int DynamixelClass::setLEDAlarm( unsigned char LEDAlarm)
{    
...
int DynamixelClass::setShutdownAlarm( unsigned char SALARM)
{    
...
int DynamixelClass::setCMargin( unsigned char CWCMargin, unsigned char CCWCMargin)
{
...
int DynamixelClass::setCSlope( unsigned char CWCSlope, unsigned char CCWCSlope)
{
...
int DynamixelClass::setPunch( int Punch)
{
...
int DynamixelClass::lockRegister()
{    
...
{	
    ...
    while (availableData() > 0){
		...
		if ( (Incoming_Byte == 255) & (peekData() == 255) ){
			...
			bool is_cw=(Load_Long_Byte&0x400)!=0;
			Load_Long_Byte&=0x03FF;
			if(!is_cw)
				Load_Long_Byte*=-1;
		}
    }
